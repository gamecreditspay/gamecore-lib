...
Transaction.MAX_MONEY = 84000000 * 1e8; // Gamecredits has 84M coins
...
Transaction.FEE_PER_KB = 100000; // Gamecredits default fees is 0.001 GAME
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://gamecore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by gamecore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a gamecore Address object. The
 * same is true for `script`, which can be a string or a gamecore Script.
 *
