...
<head>
  <meta charset="utf-8">
  <script src="bower_components/litecore/gamecore-lib.min.js"></script>
...
<body>
  ...
  <script type="text/javascript">
    var litecore = require('gamecore-lib');
...
```sh
browserify --require ./index.js:gamecore-lib | uglifyjs > gamecore-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external gamecore-lib | uglifyjs > bitcore-mnemonic.min.js
```
