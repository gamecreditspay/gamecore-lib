...
* [Peer to Peer Networking](https://github.com/litecoin-project/gamecore-p2p)
...
var imported = gamecore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new gamecore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new gamecore.URI(paymentInfo).toString();
```
